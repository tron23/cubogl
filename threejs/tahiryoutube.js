...
var coches=[];
// Objetos
var dodge, audi, nissan, ferrari, touareg, truck, dragon, boat, avion;
var materialUsuario;
...
function loadScene() {
	...
	loader3.load( 'models/dodge/dodge.json',
	         function (objeto){
                ...
                objeto.scale.set(0.40,0.40,0.40);
	         	dodge=objeto;
	         	objeto.add(new THREE.AxesHelper(3));
	...
	loader7.load( 'models/player2/boat.json', 
	         function (objeto){
	         	boat=objeto;
	...
	loader7.load( 'models/player3/avion1.json', 
	         function (objeto){
	         	avion=objeto;
