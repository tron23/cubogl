...
function loadScene() {
	...
	var geoSuelo = new THREE.PlaneGeometry(100,100,1000,100);//tamaño del suelo
	...
	loader.load( 'models/dragon/model.json',
		         function (objeto){
		         	objeto.position.y = -2;
                    //objeto.scale.set(0.05,0.05,0.05); 
		         	//cubo.add(objeto);
					var txsoldado = new THREE.TextureLoader().load('models/dragon/dragon_S.jpg');
		...
		// Objeto importado
	var loader = new THREE.ObjectLoader();
	loader.load( 'models/sep/model.json',
		         function (objeto){
		         	objeto.position.y = -1;
                    objeto.scale.set(0.05,0.05,0.05); 
		         	cubo.add(objeto);
